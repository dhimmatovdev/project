      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {t('currentLanguage') === 'en' ? 'The university admission and scholarship process in 4 simple steps' : '4 oddiy qadam orqali AQSh universitetlariga qabul va grant olish jarayoni'}
          </p>
        </div>
