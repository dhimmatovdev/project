  ...
  const features = [
    {
      ...
      description: t('currentLanguage') === 'en' ? 'Full scholarship opportunities at America\'s top universities' : 'Amerika\'ning eng yaxshi universitetlarida to\'liq grant imkoniyatlari'
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: t('aboutFeature2'),
      description: t('currentLanguage') === 'en' ? 'IELTS or Duolingo test sufficient' : 'Faqat IELTS yoki Duolingo testi yetarli'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: t('aboutFeature3'),
      description: t('currentLanguage') === 'en' ? 'Comprehensive support from professional mentors' : 'Professional mentorlar tomonidan to\'liq qo\'llab-quvvatlash'
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: t('aboutFeature4'),
      description: t('currentLanguage') === 'en' ? 'Universities matched to your profile' : 'Sizning profilingizga mos keladigan universitetlar ro\'yxati'
    }
  ];
